xenomorphs-announcement = Внимание: обнаружены враждебные биосигнатуры. Неизвестные сущности перемещаются по вентиляции и техническим туннелям станции. Всем сотрудникам немедленно инициировать протоколы изоляции и избегать пребывания в одиночестве.
...
xenomorphs-win-announcement-shuttle-call =
    ТРЕВОГА: Станция была поглощена ульем ксеноморфов. Всем оставшимся сотрудникам приказано привести в готовность ядерную боеголовку и немедленно проследовать к эвакуационному шаттлу.
    
    Установлен контакт с корпусом морской пехоты ОПЗ. Их прибытие ожидается в течение двух недель.

...
reagent-desc-triclor = Реплицируется при контакте с кровью и заставляет использовавшего постоянно блевать, быстро опустошая желудок и прочее. Относительно слаб, для убийства нужны высокие дозы. Неэффективен в следовых количествах.

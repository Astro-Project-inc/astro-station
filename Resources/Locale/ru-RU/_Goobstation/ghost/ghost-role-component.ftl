...
ghost-role-information-Gman-rules = Ты не подчиняешься никаким правилам или ограничениям. Смерть не властна над тобой, как и NanoTrasen.

# Shuttle roles

ghost-role-information-bsd-name = Представитель Синий Щит
ghost-role-information-bsd-description = Тебя вызвал на станцию Представитель NanoTrasen, подчиняйся ему, защищай командование, следуй Корпоративному Закону.
ghost-role-information-bsd-rules = Следуй приказам, данным тебе [color=yellow][bold]Представителем NanoTrasen[/bold][/color], защищай командование.
# interns
...
ghost-role-intern-desc = Ты стажёр ЦентКом, плохо оплачиваемый, голодный, с большой студенческой задолженностью, но других вариантов нет, так что лучше слушайся!
ghost-role-intern-rules = Следуй приказам, данным тебе [color=yellow][bold]Представителем NanoTrasen[/bold][/color] и ЦентКом, защищай командование, слушайся Главу стажёров.
ghost-role-lead-intern-rules = Следуй приказам, данным тебе [color=yellow][bold]Представителем NanoTrasen[/bold][/color] и ЦентКом, защищай командование, отдавай приказы другим стажёрам.

...
#knowledge-path-void-s3-desc =
    Я нашёл нить холодного дыхания. Она привела меня к странному святилищу, полностью состоящего из кристаллов.
    Прозрачных и белых — передо мной стояла фигура дворянина.
    
    Даёт вам невосприимчивость к холоду и устраняет потребность в дыхании.
    Однако вы всё ещё получаете урон при низком давлении.
...
#knowledge-path-void-s5-desc =
    Каждая дверь, что я открываю, терзает моё тело. Я боюсь того, что за ними. Кто-то ждёт меня,
    и ноги начинают подкашиваться. Это... снег?
    
    Дарует вам Взрыв пустоты — заклинание, выпускающее холодный взрыв в форме конуса,
    замораживая землю и проклиная всех, кто будет в зоне поражения.

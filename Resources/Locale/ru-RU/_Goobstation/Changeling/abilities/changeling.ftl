...
changeling-absorb-fail-incapacitated = Нельзя поглотить, пока цель не будет обездвижена.
changeling-absorb-fail-absorbed = Его уже поглотили.
changeling-absorb-fail-unabsorbable = Цель непоглощаема.
changeling-absorb-end-self = Организм поглощён. Мы эволюционируем.
changeling-absorb-end-self-ling = Другой генокрад поглощён. Наше тело наполняется силой, клетки стремительно эволюционируют.
changeling-absorb-end-self-ling-incompatible = Другой генокрад поглощён. Их текущая форма предотвращено нас от поглощения ДНК.
...
changeling-absorb-fail-onfire = Цель в огне, сначала потуши её!
...
changeling-sting-fail-self = Мы пытались ужалить { CAPITALIZE($target) }, но что-то помешало!
...
changeling-sting-fail-simplemob = Нельзя ужалить слабое существо!
changeling-sting-extract-fail = Не удалось извлечь ДНК.
changeling-sting-extract-max = Нужно избавиться от сохранённой ДНК прежде.
changeling-stasis-enter-damaged = Мы вошли в регенеративный стазис. Наши полученные травмы будет трудно залечить...
changeling-stasis-enter-catastrophic = Мы вошли в регенеративный стазис. Наши тяжкие повреждения будут излечены...
changeling-dartgun-no-stings = У нас нет эволюционированных ужалений-реагентов!
...
changeling-stasis-exit-fail-time = Наше тело всё ещё восстанавлиается!
...
changeling-hivemind-start = Мы настраиваем мозг на частоту колониального сознания.

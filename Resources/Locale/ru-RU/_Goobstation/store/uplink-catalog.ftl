...
uplink-contractor-baton-desc = Компактная дубинка для синдикатовских подрядчиков. Наносит лёгкие электрические разряды, которые могут временно оглушать цель и повреждать роботов.

...
language-Gruntish-description = Для случайного наблюдателя этот язык — непостижимая солянка ворчащих звуков. Для Они этот хаос каким-то образом понятен.
...
language-Carptongue-name = Пишис
chat-language-Carptongue-name = Пишис

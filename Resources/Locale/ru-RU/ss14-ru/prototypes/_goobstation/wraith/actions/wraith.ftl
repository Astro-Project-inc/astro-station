...
ent-ActionRaiseSkeleton = Воскрешение скелета
    .desc = Воскресите труп-скелет или призовите его в шкаф.
...
ent-ActionDefile = Осквернение
    .desc = Создайте ужасный яд внутри еды или контейнера. Сначала используйте на себе, чтобы выбрать химикат.

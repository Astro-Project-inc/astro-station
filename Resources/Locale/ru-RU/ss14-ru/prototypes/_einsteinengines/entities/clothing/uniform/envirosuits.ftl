...
ent-ClothingUniformEnvirosuitBlueshield = экокостюм Синего Щита
    .desc = Экокостюм для плазмалюдов, работающих в подразделении Синего Щита.
...
ent-ClothingUniformEnvirosuitQM = экокостюм квартирмейстера
    .desc = Герметичный костюм для плазмалюдов, способных занять должность офицера логистики.

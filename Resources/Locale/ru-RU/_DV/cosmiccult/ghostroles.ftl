...
petting-success-rogue-ascended = Уворачиваясь от хлещущих щупалец и волн астральной силы, ты каким-то чудом гладишь { $target }.
...
rogue-ascended-infection-notification = { CAPITALIZE($user) } простирает свои щупальца к { CAPITALIZE($target) }!
